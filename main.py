...
title = tk.Label(root, text='Budget Calculator', font=('helvetica', 22, 'bold'), bg='
...
income_label = tk.Label(income_inputs, text='Income', bg='
income_label.grid(row=0, column=0, columnspan=2)
salary_label = tk.Label(income_inputs, text='Salary: ', bg='
...
side_hustles_label = tk.Label(income_inputs, text='Side Hustles: ', bg='
...
gifts_label = tk.Label(income_inputs, text='Gifts: ', bg='
...
passive_label = tk.Label(income_inputs, text='Passive: ', bg='
...
filler_element = tk.Label(income_inputs, bg='
filler_element.grid(row=6, column=0)
filler_element1 = tk.Label(income_inputs, bg='
filler_element1.grid(row=6, column=1)
filler_element2 = tk.Label(income_inputs, bg='
filler_element2.grid(row=7, column=0)
filler_element3 = tk.Label(income_inputs, bg='
filler_element3.grid(row=5, column=1)
filler_element4 = tk.Label(income_inputs, bg='
...
expenses_label = tk.Label(expenses_inputs, text='Expenses', bg='
expenses_label.grid(row=0, column=0, columnspan=2)
rent_label = tk.Label(expenses_inputs, text='Rent: ', bg='
...
transport_label = tk.Label(expenses_inputs, text='Transportation: ', bg='
...
food_label = tk.Label(expenses_inputs, text='Food: ', bg='
...
investments_label = tk.Label(expenses_inputs, text='Investments: ', bg='
...
entertainment_label = tk.Label(expenses_inputs, text='Entertainment: ', bg='
...
savings_label = tk.Label(expenses_inputs, text='Saving: ', bg='
...
other_label = tk.Label(expenses_inputs, text='Other: ', bg='
